...
| 4 | CEO Dashboard | 🔲 Next — morning view: leads by stage, pipeline value, overdue, deals MTD |
| 5 | Commission Tracker | 🔲 Log deals, auto-split Nick/Monika/Reza, monthly summary |
| 6 | Client Manager | 🔲 After-sale tracking, payment alerts, title status |
| 7 | Password protection | 🔲 Shared password for agent tools, separate PIN for CEO tools |
